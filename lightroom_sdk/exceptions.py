...
class PhotoNotSelectedError(LightroomSDKError):
    ...
    def __init__(
        self,
        message: str = "Please select a photo in Lightroom",
        code: Optional[str] = None,
        details: Optional[Dict[str, Any]] = None,
    ):
...
class CatalogAccessError(LightroomSDKError):
    ...
    def __init__(
        self,
        message: str = "Failed to access Lightroom catalog",
        code: Optional[str] = None,
        details: Optional[Dict[str, Any]] = None,
    ):
...
class WriteAccessBlockedError(LightroomSDKError):
    ...
    def __init__(
        self,
        message: str = "Lightroom write operation blocked",
        code: Optional[str] = None,
        details: Optional[Dict[str, Any]] = None,
    ):
...
class ResourceUnavailableError(LightroomSDKError):
    ...
    def __init__(
        self,
        message: str = "Required Lightroom module unavailable",
        code: Optional[str] = None,
        details: Optional[Dict[str, Any]] = None,
    ):
