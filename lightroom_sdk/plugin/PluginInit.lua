...
local function registerApiCommands()
    ...
    router:register("develop.resetCrop", DevelopModule.resetCrop, "sync")
    router:register("develop.resetTransforms", DevelopModule.resetTransforms, "sync")
    router:register("develop.resetSpotRemoval", DevelopModule.resetSpotRemoval, "sync")
    router:register("develop.resetRedeye", DevelopModule.resetRedeye, "sync")
    router:register("develop.resetHealing", DevelopModule.resetHealing, "sync")
    router:register("develop.editInPhotoshop", DevelopModule.editInPhotoshop, "sync")
    ...
    router:register("catalog.createCollection", CatalogModule.createCollection, "sync")
    router:register("catalog.createSmartCollection", CatalogModule.createSmartCollection, "sync")
    router:register("catalog.createCollectionSet", CatalogModule.createCollectionSet, "sync")
    ...
    router:register("catalog.exportPhotos", CatalogModule.exportPhotos, "sync")
    router:register("catalog.addPhotosToCollection", CatalogModule.addPhotosToCollection, "sync")
    router:register("catalog.removePhotosFromCollection", CatalogModule.removePhotosFromCollection, "sync")
    router:register("catalog.batchSetMetadata", CatalogModule.batchSetMetadata, "sync")
    router:register("catalog.saveMetadata", CatalogModule.saveMetadata, "sync")
    router:register("catalog.importPhotos", CatalogModule.importPhotos, "sync")
    ...
    if SelectionModule then
        ...
        router:register("selection.toggleRedLabel", SelectionModule.toggleRedLabel, "sync")
        router:register("selection.toggleYellowLabel", SelectionModule.toggleYellowLabel, "sync")
        router:register("selection.toggleGreenLabel", SelectionModule.toggleGreenLabel, "sync")
        router:register("selection.toggleBlueLabel", SelectionModule.toggleBlueLabel, "sync")
        router:register("selection.togglePurpleLabel", SelectionModule.togglePurpleLabel, "sync")
        router:register("selection.extendSelection", SelectionModule.extendSelection, "sync")
        router:register("selection.deselectActive", SelectionModule.deselectActive, "sync")
        router:register("selection.deselectOthers", SelectionModule.deselectOthers, "sync")
    end
